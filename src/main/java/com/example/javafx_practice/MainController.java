...
public class MainController implements Initializable {
    ...
    public void AnalysisPageMove(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("ChoiceForexToAnalysis.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), WindowSize.CHOICEFOREX_X, WindowSize.CHOICEFOREX_Y);
        StageStore.stage.setTitle("ChoiceForexToAnalysis");
        StageStore.stage.setScene(scene);
        StageStore.stage.show();
    }
