...
public class Analysis {
    ...
    public static void resTableData(byte[] data){
        try {
            ...
            TableColumn tableViewColumn1 = tableView1.getColumns().get(0);//���̺���� ù��° �÷��� �����Ѵ�.
            ...
            if (score>=10){
                txtResult.setText("매수 강력 권고");
            }else if (score>=7){
                txtResult.setText("매수 권고");
            }else if (score>=3){
                txtResult.setText("평이한 상황");
            }else if (score>0){
                txtResult.setText("매도 권고");
            }
