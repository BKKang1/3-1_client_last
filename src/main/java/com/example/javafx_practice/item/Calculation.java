...
public class Calculation {
    ...
    public static void setCalculation(String ct, ChoiceBox cb, TextField tfIn, TextField tfOut){
        currencytmp_tmp = ct;
        choiceMethod = cb;
        txtExInput = tfIn;
        txtExOutput = tfOut;
    ...
    public static void reqCalculate() {
        ...
        ReqCalculationDTO calculationRequestDTO = new ReqCalculationDTO(currencytmp,exchangeOption, currentExchange);
    ...
    public static void resCalculate(byte[] data) throws IOException, ClassNotFoundException {
        ...
        txtExOutput.setText(String.valueOf(form.format(resCalculationDTO.getResultExchange())));
    }
